...
if(isset($_POST["processform"])){
	...
	$sixthfield = mysqli_real_escape_string($connection, sanitize($_POST["sixthfield"]));	 
	$sql = "INSERT INTO staffrecord(title, dateofreturn, staff_id, student_id) VALUES ('$firstfield', '$thirdfield', '$sixthfield', '$fifthfield')";
...
<script type="text/javascript">
  function validateForm() {
    ...
    var c = document.forms["Form"]["fifthfield"].value;
    var d = document.forms["Form"]["fourthfield"].value;
var e= document.forms["Form"]["sixthfield"].value;
...
<div class="container">
<div class="container">
  <form action="staffcheckout.php" method="post" name="Form" onsubmit="return validateForm()">
  <input type="hidden" name="processform" value="1">
    ...
    <div class="row">
      <div class="col-25">
        <label for="field">Studentid:</label>
      </div>
      <div class="col-75">
 ...
 <div class="row">
      <div class="col-25">
        <label for="field">Staffid:</label>
      </div>
      <div class="col-75">
        <input type="text" id="field6" name="sixthfield" placeholder="Value...">
      </div>
    </div>
    <div class="row">
